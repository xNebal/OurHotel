...
<head>
    <title>Hotel Del Luna|Contact</title>
    <meta charset="utf-8">
...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <p>نحن في فندق القمر عائلة واحدة كبيرة و كادرنا يعمل بانتظام معاً لأكثر من عشر سنوات و نستمتع بجو من
                        الانسجام و الدفء ما ينعكس في كل ما نقوم به و في الترحيب الحقيقي لضيوفنا </p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-cover" data-stellar-background-ratio="0.5" style="background-image: url(assets/img/web_picture3.png);">
        <div class="container">
