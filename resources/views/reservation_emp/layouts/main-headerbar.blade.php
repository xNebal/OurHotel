			...
			<ul class="nav user-menu">
								...
								<li class="notification-message">
									<a href="#">
										<div class="media"> <span class="avatar avatar-sm">
											<img class="avatar-img rounded-circle" alt="User Image" src="{{ URL::to('assets/img/profiles/avatar-02.jfif') }}">
											</span>
				...
				<li class="nav-item dropdown has-arrow">
					...
					<div class="dropdown-menu">
						...
						<a class="dropdown-item" href="{{ route('logout') }}l">Logout</a> </div>
				</li>
			</ul>
