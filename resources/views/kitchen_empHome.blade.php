        ...
        <div class="card board1 fill">
            <div class="card-body">
                <div class="dash-widget-header">
                    <div>
                        <h3 class="card_widget_header">{{ $count = DB::table('orders')->count(); }}</h3>
    ...
    <div class="col-xl-3 col-sm-6 col-12">
        <div class="card board1 fill">
            <div class="card-body">
                <div class="dash-widget-header">
                    <div>
                        <h3 class="card_widget_header">{{ $count = DB::table('orders')->where('state','Pinnding')->count(); }}</h3>
        ...
        <div class="card board1 fill">
            <div class="card-body">
                <div class="dash-widget-header">
                    <div>
                        <h3 class="card_widget_header">{{ $count = DB::table('orders')->where('state','Pinnding')->count(); }}</h3>
                        <h6 class="text-muted">Pinnding Orders</h6>
                    </div>
                    <div class="ml-auto mt-md-3 mt-lg-0"> <span class="opacity-7 text-muted"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24"
                                fill="none" stroke="#009688" stroke-width="2" stroke-linecap="round"
                ...
                <div class="dash-widget-header">
                    <div>
                        <h3 class="card_widget_header">
                            {{ $count = DB::table('orders')->where('state','Canceled')->count(); }}</h3>
